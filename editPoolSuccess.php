...
// ECHO THE HEADER
echo "<h2>Pool successfully updated!</h2>";
?>
<p>Your pool has been updated!  Now you can either go add some questions to your pool, or go back to manage your class settings.</p>
<ul>
